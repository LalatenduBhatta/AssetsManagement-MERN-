function EmployeeEditModal({ setIsModalOpen }) {
    return (
        <>
            {/* <!-- Edit user modal --> */}
                ...
                <div class="relative w-full max-w-2xl max-h-full">
                    ...
                    <form class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                        ...
                        <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600 border-gray-200">
                            ...
                            <button onClick={() => setIsModalOpen(false)} type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="editUserModal">
