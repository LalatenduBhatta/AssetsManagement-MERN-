...
function Employees() {
    ...
    return (
        <>
                ...
                <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <td>
                                <div className="text-base font-semibold">79814416545</div>
                            </td>
                            <td className="px-6 py-4">
                            ...
                            <td className="px-6 py-4 flex w-full justify-start gap-4">
                                ...
                                <button className="text-md text-white  hover:underline bg-blue-500 py-2 px-2 rounded-full"
                                    onClick={() => setIsModalOpen(true)}>Edit user</button>
            ...
            {isModalOpen && <EmployeeEditModal setIsModalOpen={setIsModalOpen} />}
        </>
    )
}
